        ...
        <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded)=>handleChange(isExpanded,'panel1')}>
            ...
            <AccordionDetails>
                <Typography>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                            Aut nam voluptates officia dolore voluptatem rem! Dolores excepturi eius officia possimus 
                            sunt atque inventore enim mollitia maxime est. Debitis, sint dicta.
                </Typography>
            </AccordionDetails>
        </Accordion>
